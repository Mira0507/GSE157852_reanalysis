...
title: "BaseMean Analysis in SARS-CoV-2-infected Human Neuron Cells"
author: "Mira Sohn" 
---
...
### - DE analysis: [Link I](https://github.com/Mira0507/GSE157852/blob/master/DE_EnsDb.Rmd), [Link II]()
...
# Import data
diff.high <- fread("h.baseMean_SA_ST.csv")[1:50, -1][, Group := "High"]
diff.low <- tail(fread("h.baseMean_SA_ST.csv"), 50)[, -1][, Group := "Low"]
